...
error_reporting(1);
include('../../lang/en.php');
define('SITE_URL', 'http://192.168.1.111/baybarter/');
define('BASE_URL', 'http://192.168.1.111/baybarter/');
...
//mysql_select_db("baybarter", $link) or die("Database not Found. Please Create the Database.");

$con=mysqli_connect("localhost","root","Host@2017","baybarter");
