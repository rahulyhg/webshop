...
{
  $item_id=$_GET['cid'];
  mysqli_query($con,"delete from  webshop_subcategory where id='".$item_id."'");
...
{
$categoryRowset = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `webshop_subcategory` WHERE `status`='1'"));
...
<!-- Header End -->
 <!-- BEGIN CONTAINER -->
   <div id="container" class="row-fluid">
    ...
    <?php include("includes/left_sidebar.php"); ?>
      ...
      <div id="main-content">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <h4><i class="icon-reorder"></i>List SubCategory</h4>
        ...
        <tbody>
                            <?php
                                                        $fetch_tools_type=mysqli_query($con,"select * from webshop_subcategory WHERE `status`='1'");
   ...
   $category_name=mysqli_fetch_array(mysqli_query($con,"select * from webshop_category WHERE `id`='".$tools_type['category_type']."'"));                                                  
// $number_listed = mysqli_num_rows(mysqli_query($con,"SELECT * FROM `uidesign_products` WHERE `subcategory_type`='".$tools_type['id']."'"));

// $number_of_suppliers = mysqli_num_rows(mysqli_query($con,"SELECT * FROM `uidesign_products` WHERE `subcategory_type`='".$tools_type['id']."' group by seller_id"));
                                                           
    if($tools_type['image']!='')
    {
    $image_link='../upload/tool_image/'.$tools_type['image'];
    }
    else {
    $image_link='../upload/no.png';
              ...
              <tr>
               ...
               <td>
                ...
                <td>
                   <?php echo stripslashes($category_name['name']);?>
                </td>


            <!--      <td>
                   <?php echo stripslashes($number_listed);?>
                </td>

                <td>
                   <?php echo stripslashes($number_of_suppliers);?>
                </td> -->
               ...
               <td>
                 <img src="../upload/subcategory_image/<?php echo $tools_type['image'];?>" height="100" width="100" align="image">
                </td> 
               
                
                <td>

                    <a  href="details_subcategory.php?id=<?php echo $tools_type['id'] ?>&action=details"><i class="icon-eye-open"></i></a>
                  <a  href="add_subcategory.php?id=<?php echo $tools_type['id'] ?>&action=edit">
