                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                      ...
                      <!--   <h4><i class="icon-reorder"></i>List Pets</h4> -->
                        <tr><button type="reset" class="btn blue" onClick="window.location.href='list_owner.php'" >Back</button></tr>
...
// }
    ...
    $fetch_landlord=mysqli_query($con,"select * from webshop_pets where owner_id='".$_REQUEST['id']."'");
