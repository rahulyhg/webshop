...
if(isset($_POST['ExportCsv']))
{
   ...
   $sql="select * from webshop_items where `item_options` ='2' AND `status` ='1' order by id desc";
    ...
    <?php include("includes/left_sidebar.php"); ?>
      ...
      <div id="main-content">
        ...
        <tbody>
                            ...
                            $fetch_items=mysqli_query($con,"select * from webshop_items where `item_options` ='2' AND `status` ='1'");
...
$image_link='../upload/no.jpg';
              ...
              <tr>
                ...
                <td>
                  <a  href="details_request.php?id=<?php echo $items['id'];?>&action=details">
                 Details </a>
              </td>
