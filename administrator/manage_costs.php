...
{
  $item_id=$_GET['cid'];
  mysqli_query($con,"delete from  webshop_petcosts where id='".$item_id."'");
...
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="manage_costs.php?cid="+ aa +"&action=delete"
      }  
   } 
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">Manage Costs</h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <h4><i class="icon-reorder"></i>List Costs</h4>
...
if(isset($_GET['action']) && $_GET['action']=='active')
{
  ...
  exit();
                                                        ...
                                                        $fetch_landlord=mysqli_query($con,"select * from webshop_petcosts order by id desc");
    ...
    $image_link='../upload/user_image/nouser.jpg';
              ...
              <td>
                  <?php echo stripslashes($landlord['weight']);?>
                </td> 
                                                         
                <td>
                  <?php echo stripslashes("$".$landlord['cost']);?>
                </td>
                
                <td>
                  <a  href="add_costs.php?id=<?php echo $landlord['id'] ?>&action=edit">
