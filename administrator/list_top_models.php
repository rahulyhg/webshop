...
<script language="javascript">
    function del(aa, bb)
    {
        ...
        if (a)
        {
            location.href = "list_top_models.php?cid=" + aa + "&action=delete"
        }
    }

    function inactive(aa)
    {
        location.href = "list_top_models.php?cid=" + aa + "&action=inactive"

    }
    function active(aa)
    {
        location.href = "list_top_models.php?cid=" + aa + "&action=active";
    }
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>List Top Model</h4>
                            <span class="tools">
...
while($row=mysqli_fetch_object($record))
  ...
  $img='../upload/product_image/'.$row->image;
  }
...
?>
            ...
            <tr>
                ...
                <td>
                  <a  href="add_topmodels.php?id=<?php echo $row->id ?>&action=edit">
