    ...
    <?php include("includes/left_sidebar.php"); ?>
      ...
      <div id="main-content">
        ...
        <tbody>
             ...
             $tool_type_details = mysqli_query($con,"SELECT * FROM `webshop_bookings` order by id desc");
              ...
              <!--   <td>
                ...
                <!--   <td>
                 ...
                 <td>
                  ...
                  <td>
                  <?php if($result['ride_status'] == '0'){
                  echo '<span style="color:#f44336;text-align:center;">Pending</span>';

                  }else if($result['ride_status'] == '1'){
                     echo '<span style="color:#4caf50;text-align:center;">On Trip</span>';
                  }else{
                    echo '<span style="color:#795548;text-align:center;">Completed</span>';
                  }
                    ?>
