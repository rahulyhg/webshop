...
$userRow = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `webshop_user` WHERE `id`='".mysqli_real_escape_string($con,$_REQUEST['id'])."'"));
...
<tr>
<td> Contact No. </th> 
<td><?php echo $userRow['jikoo_number']; ?></td>    
</tr>
...
<tr>    
<td> Last Login </th>
<td> <?php echo $userRow['last_login'];?> </td>
</tr>
...
<td> Image </td>
<?php
$moreimage1 = mysqli_query($con,"SELECT * FROM `webshop_user` WHERE `id`='".mysqli_real_escape_string($con,$_REQUEST['id'])."'");
while($moreimage=mysqli_fetch_array($moreimage1))
{

if($moreimage['image']!="")
{
$image_link='../upload/userimage/'.$moreimage['image'];
}
else
{
