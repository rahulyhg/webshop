...
if (isset($_REQUEST['submit'])) {
   ...
   $price = isset($_POST['price']) ? $_POST['price'] : '';
    ...
    if ($action == 'add' || $action == '') {
       ...
       echo $addQuery = "INSERT INTO `webshop_cms` (`" . implode('`,`', array_keys($fields)) . "`)"
...
{
$categoryRowset = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `webshop_cms`"));
...
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="manage_page.php?cid="+ aa +"&action=delete"
      }  
   } 
   
function inactive(aa)
   { 
       location.href="manage_page.php?cid="+ aa +"&action=inactive"

   } 
   function active(aa)
   {
     location.href="manage_page.php?cid="+aa+"&action=active";
   } 
   ...
   <div id="container" class="row-fluid">
    ...
    <?php include("includes/left_sidebar.php"); ?>
      ...
      <div id="main-content">
        ...
        <tbody>
                            <?php
                                                        $fetch_subscription=mysqli_query($con,"select * from webshop_cms");
    ...
    $image_link='../upload/no.png';
              ...
              <tr>
                ...
                <td>
                  <?php echo stripslashes($subscription['pagename']);?>
                </td>
