...
if(isset($_GET['action']) && $_GET['action']=='delete')
{
	...
	header('Location:list_featured_group.php');
	exit();
}
...
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="list_featured_group.php?cid="+ aa +"&action=delete"
      }  
   } 
   
function inactive(aa)
   { 
       location.href="list_featured_group.php?cid="+ aa +"&action=inactive"

   } 
   function active(aa)
   {
     location.href="list_featured_group.php?cid="+aa+"&action=active";
   } 
   ...
   <div id="container" class="row-fluid">
    ...
    <?php include("includes/left_sidebar.php"); ?>
      ...
      <div id="main-content">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">Group Featured for Group</h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
                       ...
                       <li>
                           <a href="#">Group Featured for Group</a>
        ...
        <tbody>
    <?php
    $fetch_product=mysqli_query($con,"select * from webshop_group WHERE feature_group='Yes'");
