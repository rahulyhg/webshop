...
$fields = array('admin_username' => mysqli_real_escape_string($con,$in_user2));
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Change User Name</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                          <form action="changeusername.php" class="form-horizontal" method="post"  enctype="multipart/form-data">
