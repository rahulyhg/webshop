...
if (isset($_REQUEST['submit'])) {
    ...
    $message= $_POST['elm1'];
      ...
      // $fetch_landlord=mysqli_query($con,"select * from webshop_user where default_language= '".$language."' and type =2");
    $fetch_landlord=mysqli_query($con,"select * from webshop_user where default_language IN('All','".$language."') and type =2");
      ...
      $MailTo = $landlord['email'];  
       ...
       $TemplateMessage.="<br/><br />Hi Vendor,";
        $TemplateMessage.="<br>";
...
$YourEamilPassword="lsnspyrcimuffblr";
  ...
  header('location:broadcast_vendor.php');
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                          <form class="form-horizontal"  method="post" action="broadcast_vendor.php">
