            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">
                   Lender <small><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Lender</small>
                   </h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
                       ...
                       <li>
                          <span><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Lender</span>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Add Lender</h4>
                            <span class="tools">
