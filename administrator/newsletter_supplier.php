...
if (isset($_REQUEST['submit'])) {
    ...
    foreach ($new_email as $email_id) {
       ...
       $TemplateMessage.="<br/><br />Hi Supplier,";
        $TemplateMessage.="<br>";
        ...
        $TemplateMessage.="Insulationez Team";
...
$YourEamilPassword="lsnspyrcimuffblr";
  ...
  header('location:newsletter_supplier.php');
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Newsletter</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                          <form class="form-horizontal"  method="post" action="newsletter_supplier.php">
                            
                            
                               <div class="control-group">
                                    <label class="control-label">All</label>
                                    <div class="controls">
                                <input type="checkbox" class="form-control" id="sel_user">&nbsp;Selected Supplier
                                    </div>
                                </div>
