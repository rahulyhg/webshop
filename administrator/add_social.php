...

{
  ...
  $fields = array(
   ...
   if($_REQUEST['action']=='edit')
    ...
    {
    $target_path="../upload/social_image/";
    ...
    $image =mysqli_query($con,"UPDATE `webshop_social` SET `image`='".$img_name."' WHERE `id` = '" . mysqli_real_escape_string($con,$_REQUEST['id']) . "'");
    }
   ...
   $addQuery = "INSERT INTO `webshop_social` (`" . implode('`,`', array_keys($fields)) . "`)"
    ...
    $image =mysqli_query($con,"UPDATE `webshop_social` SET `image`='".$img_name."' WHERE `id` = '" . $last_id . "'");
    }
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="fa fa-gift"></i><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Social Media</h4>
                            <span class="tools">
                         ...
                         <form  class="form-horizontal" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $_REQUEST['id'];?>" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                   <input type="file" name="image" class=" btn blue"  ><?php if($categoryRowset['image']!=''){?><br><a href="../upload/social_image/<?php echo $categoryRowset['image'];?>" target="_blank">View</a><?php }?>
                                    </div>
                                </div>
                            ...
                            <a href="social.php"><button class="btn"> Back</button></a>
                            <!-- END FORM-->
                        </div>
                    </div>
