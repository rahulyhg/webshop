...
if(isset($_GET['action']) && $_GET['action']=='delete')
{
	...
	header('Location:list_lodger.php');
	exit();
}
...
if (isset($_REQUEST['submit'])) {
    ...
    if ($action == 'add' || $action == '') {
       ...
       echo $addQuery = "INSERT INTO `webshop_lodger` (`" . implode('`,`', array_keys($fields)) . "`)"
        ...
        $last_id = $_REQUEST['id'];
		$editQuery = "UPDATE `webshop_lodger` SET " . implode(', ', $fieldsList)
...
if(isset($_REQUEST['bulk_delete_submit'])){
        ...
        foreach($idArr as $id){
            ...
            mysqli_query($con,"DELETE FROM `webshop_lodger` WHERE id=".$id);
        }
        $_SESSION['success_msg'] = 'Lodgers have been deleted successfully.';
...
if(isset($_POST['ExportCsv']))
{
   ...
   $sql="select * from webshop_user WHERE `type`='2' order by id desc";
...
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="list_lodger.php?cid="+ aa +"&action=delete"
      }  
   } 
   
function inactive(aa)
   { 
       location.href="list_lodger.php?cid="+ aa +"&action=inactive"

   } 
   function active(aa)
   {
     location.href="list_lodger.php?cid="+aa+"&action=active";
   } 
   ...
   <div id="container" class="row-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">Lodger list</h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
                        ...
                        <div class="widget-title">
                             <form action="" method="post">
								<!--<i class="fa fa-edit"></i>Editable Table-->
                                                                <button type="submit"   name="ExportCsv"> Download Lodger List</button>
                                                            </form>
    ...
    $image_link='../upload/no.png';
              ...
              <tr>
                ...
                <td>
                  <a  href="add_lodger.php?id=<?php echo $landlord['id'] ?>&action=edit">
                  Edit </a>
                </td>
