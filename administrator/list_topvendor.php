...
function top1(aa)
   { 
       location.href="list_topvendor.php?cid="+ aa +"&action=top1"
   ...
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="list_topvendor.php?cid="+ aa +"&action=delete"
      }  
   } 
   
function inactive(aa)
   { 
       location.href="list_topvendor.php?cid="+ aa +"&action=inactive"

   } 
   function active(aa)
   {
     location.href="list_topvendor.php?cid="+aa+"&action=active";
   } 

    function disable(aa)
   { 
       location.href="list_topvendor.php?cid="+ aa +"&action=disable"

   } 
   function enable(aa)
   {
     location.href="list_topvendor.php?cid="+aa+"&action=enable";
   }
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">Certified Vendor list</h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
                       ...
                       <li>
                           <a href="#">Certified Vendor list</a>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <h4><i class="icon-reorder"></i>List Certified Vendor</h4>
...
//          header('Location:list_topuser.php');
//   exit();
// }
...
{
   $item_id=$_GET['cid'];
  mysqli_query($con,"update webshop_user set status='0',top_user_vendor ='0' where id='".$item_id."'");
...
{
   $item_id=$_GET['cid'];
  mysqli_query($con,"update webshop_user set is_admin_approved='1' where id='".$item_id."'");
         header('Location:list_topvendor.php');
  exit();
}
...
{
   $item_id=$_GET['cid'];
  mysqli_query($con,"update webshop_user set top_user_vendor='0' where id='".$item_id."'");
         header('Location:list_topvendor.php');
  exit();
}


                                                        $fetch_landlord=mysqli_query($con,"select * from webshop_user WHERE `type`='2' and top_user_vendor =1");
    ...
    $image_link='../upload/user_image/nouser.jpg';
            ...
            <!--       <td>
                 ...
                 <td>
                    ...
                    <?php echo "<br/>(Uncheck for Normal Vendor)"; ?>
                </td> 
                ...
                <td>
                 ...
                 <td>
                  <a  href="certifiedvendor_products.php?id=<?php echo $landlord['id'] ?>&action=details">
                  List Products</a>
                  </td>

                <td>
                  <a  href="view_topvendordetails.php?id=<?php echo $landlord['id'] ?>&action=details">
                  Details</a>|
                   <a  href="view_topvendorreviews.php?id=<?php echo $landlord['id'] ?>&action=details">
                  Reviews</a>
                </td>
 ...
 -->
              <!--   <td>
               ...
               <td>
                  <?php if($landlord['is_admin_approved']=='0'){
                    ...
                    <a  onClick="javascript:enable('<?php echo $landlord['id'];?>');">
                      <br>
                    Click to Approve</a>
                    <?php } else if($landlord['is_admin_approved']=='1'){
