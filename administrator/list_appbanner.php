...
<!-- <script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="list_appbanner.php?cid="+ aa +"&action=delete"
      }  
   } 
   </script> -->
...
<script language="javascript">
    ...
    {
        location.href = "list_appbanner.php?cid=" + aa + "&action=inactive"

    }
    function active(aa)
    {
        location.href = "list_appbanner.php?cid=" + aa + "&action=active";
    }
...
?>
            ...
            <tr>
                ...
                <td>
                  <a  href="add_appbanner.php?id=<?php echo $row->id ?>&action=edit">
                  Edit </a>
                
                 <!-- <a  href="list_appbanner.php?id=<?php echo $row->id ?>&action=delete"" class="delete">
                  Delete </a> -->
