...
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="list_provider.php?cid="+ aa +"&action=delete"
      }  
   } 
   
function inactive(aa)
   { 
       location.href="list_provider.php?cid="+ aa +"&action=inactive"

   } 
   function active(aa)
   {
     location.href="list_provider.php?cid="+aa+"&action=active";
   } 
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <h4><i class="icon-reorder"></i>List Provider </h4>
    ...
    $image_link='../upload/user_image/nouser.jpg';
            ...
            <td>
              ...
              <!--    <td>
                ...
                <td>
                  <a  href="add_provider.php?id=<?php echo $landlord['id'] ?>&action=edit">
