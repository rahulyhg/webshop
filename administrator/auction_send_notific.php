...
function top1(aa)
   { 
       location.href="auction_send_notific.php?cid="+ aa +"&action=top1"
               ...
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
                           <a href="#"> Send Notification to User</a>                        
                       </li>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <h4><i class="icon-reorder"></i>Check to send Notification to User</h4>
...
if(isset($_GET['action']) && $_GET['action']=='top1')
{
  ...
  //mysqli_query($con,"update webshop_user set top_user_vendor='1' where id='".$item_id."'");
   ...
   mysqli_query($con, "INSERT INTO webshop_notification (from_id, to_id, msg)
    VALUES ('0','".$item_id."','Auction Notification')");
   
   //mysqli_query($con,"update webshop_user set top_user_vendor='1' where id='".$item_id."'");
   
   
   
         header('Location:auction_send_notific.php');
  exit();
}
    ...
    $image_link='../upload/user_image/nouser.jpg';
            ...
            <!--       <td>
                 ...
                 <td>                      
                     ...
                     <?php echo "<br/>(Check for Send Notification to User)"; ?>
