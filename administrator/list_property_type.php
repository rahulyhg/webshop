...
{
  $item_id=$_GET['cid'];
  mysqli_query($con,"delete from  webshop_property_type where id='".$item_id."'");
...
if (isset($_REQUEST['submit'])) {
   ...
   $name = isset($_POST['name']) ? $_POST['name'] : '';
    ...
    if ($action == 'add' || $action == '') {
       ...
       echo $addQuery = "INSERT INTO `webshop_property_type` (`" . implode('`,`', array_keys($fields)) . "`)"
      . " VALUES ('" . implode("','", array_values($fields)) . "')";
        ...
        $last_id = $_REQUEST['id'];
    $editQuery = "UPDATE `webshop_property_type` SET " . implode(', ', $fieldsList)
...
if(isset($_REQUEST['bulk_delete_submit'])){
        ...
        foreach($idArr as $id){
            ...
            mysqli_query($con,"DELETE FROM `webshop_property_type` WHERE id=".$id);
        }
...
{
$categoryRowset = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `webshop_property_type` WHERE `status`='1'"));
   ...
   <div id="container" class="row-fluid">
    ...
    <?php include("includes/left_sidebar.php"); ?>
      ...
      <div id="main-content">
        ...
        <tbody>
                            <?php
                                                        $fetch_property_type=mysqli_query($con,"select * from webshop_property_type WHERE `status`='1'");
    ...
    $image_link='../upload/no.png';
              ...
              <tr>
                ...
                <td>
                  <a  href="add_property_type.php?id=<?php echo $property_type['id'] ?>&action=edit">
                  Edit </a>
                </td>
