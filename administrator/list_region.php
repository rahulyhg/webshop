...
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="list_region.php?cid="+ aa +"&action=delete"
      }  
   } 
   
function inactive(aa)
   { 
       location.href="list_region.php?cid="+ aa +"&action=inactive"

   } 
   function active(aa)
   {
     location.href="list_region.php?cid="+aa+"&action=active";
   } 
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="fa fa-edit"></i>List Region</h4>
                            <span class="tools">
...
$count=1;
...

  {
        ...
        $sqlcity = mysqli_query($con,"SELECT * FROM webshop_city WHERE `id`='".mysqli_real_escape_string($con,$row->city_id)."'");
        $result22 = mysqli_fetch_assoc($sqlcity);
        
              
            $cat=mysqli_query($con,"select * from `webshop_region`");
...
?>
              ...
              <tr>
                ...
                <td>                 
                  <?php echo stripslashes($result22['name']); ?>
                </td>
                
                <td>
                  <a onClick="window.location.href='add_region.php?id=<?php echo $row->id ?>&action=edit'">Edit</a>
                </td>
                                                                <td>
