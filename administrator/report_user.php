...
if(isset($_GET['action']) && $_GET['action']=='active')
{
  ...
  exit();
                                                        ...
                                                        $fetch_landlord=mysqli_query($con,"select * from webshop_reports group by to_id");
 ...
 $total_reports = mysqli_num_rows($reports_user);
    ...
    if($abuseduser_details['image']!='')
    {
    $image_link='../upload/user_image/'.$abuseduser_details['image'];
    }
    else {
    $image_link='../upload/user_image/nouser.jpg';
              ...
              <tr>
                ...
                <td>
                  <?php echo stripslashes($abuseduser_details['fname']." ".$abuseduser_details['lname']);?>
                </td> 

                <td>
                  <a  href="get_reportsuser.php?id=<?php echo $landlord['to_id']?>&action=details">
                  <?php echo stripslashes($total_reports);?></a>
                </td>

                  <td>
                  <?php echo stripslashes($abuseduser_details['add_date']);?>
                </td> 
