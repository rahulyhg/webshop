...
<!-- Header End -->
    ...
    <?php include("includes/left_sidebar.php"); ?>
      ...
      <div id="main-content">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">Completed Trips</h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
        ...
        <tbody>
             ...
             $tool_type_details = mysqli_query($con,"SELECT * FROM `webshop_bookings` WHERE ride_status = '2' order by id desc");
 ...
 // $user_ratings = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `webshop_reviews` WHERE `from_id`='".$result['owner_id']."' and `to_id`='".$result['provider_id']."'"));
...
<!--                           <td>
                <?php
    for($x=1;$x<=$user_ratings['rating'];$x++) { ?>
        <i class="icon-star icon-a"></i>
    <?php }
    if (strpos($user_ratings['rating'],'.')) { ?>
