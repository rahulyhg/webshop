    ...
    <?php include("includes/left_sidebar.php"); ?>
      ...
      <div id="main-content">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">
                   Subscription <small><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Subscription</small>
                   </h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Add Subscription</h4>
                            <span class="tools">
                        ...
                        <form class="form-horizontal" method="post">
                                ...
                                <div class="control-group">
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                    <input type="text" class="form-control" placeholder="Enter slots" value="<?php echo $categoryRowset['slots'];?>" name="slots" required>
                                    </div>
                                </div>
         ...
         <div class="form-actions">
                             ...
                             <a href="list_subscription.php"><button class="btn"> Back</button></a>
                            <!-- END FORM-->
                        </div>
                    </div>
