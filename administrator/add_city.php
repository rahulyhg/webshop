            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">
                <?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> City
                   </h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="fa fa-gift"></i><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> City</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                       <form class="form-horizontal" method="post" action="add_city.php" enctype="multipart/form-data">
