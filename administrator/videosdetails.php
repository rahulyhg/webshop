...
$webshops = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `webshop_advertisement` WHERE `id`='".$_REQUEST['id']."'"));
// print_r($webshops);
// exit;
$userRow = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `webshop_user` WHERE `id`='".$webshops['user_id']."'"));
   ...
   <div id="container" class="row-fluid">
    ...
    <?php include("includes/left_sidebar.php"); ?>
      ...
      <div id="main-content">
        ...
        <tr><button type="reset" class="btn blue" onClick="window.location.href='list_advertisement.php'" >Back</button></tr>
...
<tr>    
<td> Video Name </th>
<td><?php echo $webshops['video']; ?></td>
</tr>

<tr>    
<td> Play Video </th>
<td> <a href="../upload/advertisement_video/<?php echo $webshops['video'];?>" target="_blank">Play Video</a></td>
</tr>

<tr>    
<td> Duration </th>
<td><?php echo $webshops['duration']; ?></td>
</tr>

<tr>    
<td> Description </th>
<td><?php echo $webshops['description']; ?></td>
</tr>


<tr>    
<td> Price </th>
<td><?php echo "$".$webshops['price']; ?></td>
</tr>

<tr>    
<td> Payment Status </th>
<td><?php echo $webshops['payment_status']; ?></td>
</tr>


<tr>    
<td> Uploaded Date </th>
<td><?php echo $webshops['add_date']; ?></td>
</tr>

<tr>
<td>Uploader Image </td>
<?php
