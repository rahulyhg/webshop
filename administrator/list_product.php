...
<script language="javascript">
    ...
    {
        location.href = "list_product.php?cid=" + aa + "&action=active" + "&name=" + name + "&email=" + email;
    }
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">List Product Requests</h3>
                    <ul class="breadcrumb">
                        <li>
                            <a href="#">Home</a>
                        ...
                        <li>
                            <a href="#">List Product Requests</a>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>List Product Requests</h4>
                            <span class="tools">
