...
if(isset($_GET['action']) && $_GET['action']=='delete')
{
  ...
  header('Location:paid_advertisement.php');
  exit();
}
...
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="paid_advertisement.php?cid="+ aa +"&action=delete"
      }  
   } 
   
function inactive(aa)
   { 
       location.href="paid_advertisement.php?cid="+ aa +"&action=inactive"

   } 
   function active(aa)
   {
     location.href="paid_advertisement.php?cid="+aa+"&action=active";
   } 
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">Pending Advertisement</h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
                       ...
                       <li>
                           <a href="#">Pending Advertisement</a>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <h4><i class="icon-reorder"></i>Pending Advertisement</h4>
...
if(isset($_GET['action']) && $_GET['action']=='active')
{
  ...
  exit();
                                                        ...
                                                        $fetch_landlord=mysqli_query($con,"select * from webshop_advertisement where payment_status ='1'");
