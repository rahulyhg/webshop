...
//
//
//$vendor_id = $_REQUEST['cid'];
//    $is_delete = 1;
//        
//    $editQuerydel = "UPDATE `webshop_user` SET `is_delete` = " .$is_delete. " WHERE `id` = '" . mysqli_real_escape_string($con, $vendor_id) . "'";
...
<script type="text/javascript">
    ...
    function del(aa)
    {
       ...
       // alert(aa);
        if (a)
        {
            location.href = "list_blocked_vendor.php?cid=" + aa + "&action=delete"
        }
    }
    
     function block(aa)
    {
        var a = confirm("Are you sure, you want to Unblock this Vendor?")
       // alert(aa);
        if (a)
        {
            location.href = "list_blocked_vendor.php?cid=" + aa + "&action=block"
        }
    }
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">Blocked Vendor list</h3>
                    <ul class="breadcrumb">
                        <li>
                            <a href="#">Home</a>
                        ...
                        <div class="widget-body">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                <tbody>
                                    ...
                                    $fetch_landlord = mysqli_query($con, "select *,@a:=@a+1 serial_number from webshop_user,(SELECT @a:= 0) AS a WHERE `type`='2' and is_blocked=1 and is_deleted=0 and email_verified=1");
                                        ...
                                        while ($landlord = mysqli_fetch_array($fetch_landlord)) {
                                            ...
                                            <tr>
                                               ...
                                               <td>
                                                ...
                                                <td>
                                                    <?php if ($landlord['is_admin_approved'] == '1') { ?>
                                                ...
                                                <td>
                                                    <?php echo stripslashes($landlord['fname'] . " " . $landlord['lname'].$landlord['id']); ?>
                                                </td> 
