    ...
    if(isset($_REQUEST['submit']))
  {
   ...
   $editQuery = "UPDATE `webshop_sitesettings` SET " . implode(', ', $fieldsList)
    ...
    if (mysqli_query($con,$editQuery)) {
      $_SESSION['msg'] = "Free Bid Updated Successfully";
    }
    else {
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Freebid Settings</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                          ...
                          <form action="freebid_settings.php" class="form-horizontal" method="post"  enctype="multipart/form-data">
                                ...
                                <label class="control-label">Free Bid</label>
                                <div class="controls">
