...
if(isset($_GET['action']) && $_GET['action']=='delete')
{
  ...
  header('Location:pets_found.php');
  exit();
}
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">Found Pets list</h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <h4><i class="icon-reorder"></i>List Pets Found</h4>
...
if(isset($_GET['action']) && $_GET['action']=='active')
{
  ...
  exit();
                                                        ...
                                                        $fetch_landlord=mysqli_query($con,"select * from webshop_pets where pets_status ='3' order by id desc");
 ...
 $total_reports = mysqli_num_rows($reports_user);
    ...
    $image_link='../upload/pets_image/nouser.jpg';
              ...
              <tr>
                ...
                <td>
                  <?php echo stripslashes($landlord['age']);?>
                </td> 
                ...
                <td>
                  <a  href="view_founder.php?id=<?php echo $landlord['id'] ?>&action=details">
                  View Founder</a>
                </td>
