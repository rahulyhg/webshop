    ...
    <?php include("includes/left_sidebar.php"); ?>
      ...
      <div id="main-content">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">
                   User Subscription <small><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> User Subscription</small>
                   </h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
                       ...
                       <li>
                          <span><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> User Subscription</span>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Add User Subscription</h4>
                            <span class="tools">
         ...
         <div class="form-actions">
                            ...
                            <a href="list_user_subscription.php"><button class="btn"> Back</button></a>
                            <!-- END FORM-->
                        </div>
                    </div>
