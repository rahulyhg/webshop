...
$YourEamilPassword="lsnspyrcimuffblr";
  ...
  header('location:newsletter_user.php');
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                          <form class="form-horizontal"  method="post" action="newsletter_user.php">
                            ...
                            <div class="controls">
                                ...
                                <?php
                                 ...
                                 $sql = "SELECT * FROM webshop_user where  type = '1' AND `status`=1";
