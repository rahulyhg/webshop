...
{
  $item_id=$_GET['cid'];
  mysqli_query($con,"delete from webshop_blogs where id='".$item_id."'");
...
{
$categoryRowset = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `webshop_blogs`"));
...
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="list_blogs.php?cid="+ aa +"&action=delete"
      }  
   } 
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <h4><i class="icon-reorder"></i>List Blogs</h4>
...
if(isset($_GET['action']) && $_GET['action']=='active')
{
  ...
  exit();
                                                        ...
                                                        $fetch_landlord=mysqli_query($con,"select * from webshop_blogs order by id desc");
    ...
    $image_link='../upload/user_image/nouser.jpg';
              ...
              <tr>
                ...
                <td>
                  <?php echo stripslashes($landlord['title']);?>
                </td> 

                 <td>
                  <?php echo stripslashes($landlord['content']);?>
                </td> 
                
                 <td>
                  <a  href="view_comments.php?id=<?php echo $landlord['id'] ?>&action=details">
                  <i class="icon-comments"></i> </a>
                </td>
              
                <td>
                  <a  href="add_blog.php?id=<?php echo $landlord['id'] ?>&action=edit">
