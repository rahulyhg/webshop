...
<script type="text/javascript">
    ...
    function disable(aa)
    {
        location.href = "list_user.php?cid=" + aa + "&action=disable"

    }
    function enable(aa)
    {
        location.href = "list_user.php?cid=" + aa + "&action=enable";
    }
...
$fetch_landlord = mysqli_query($con, "select * from webshop_user WHERE `type`='1' and top_user_vendor =0");
