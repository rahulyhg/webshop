        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">Normal User list</h3>
                    <ul class="breadcrumb">
                        <li>
                            <a href="#">Home</a>
...
$fetch_landlord = mysqli_query($con, "select *,@a:=@a+1 serial_number from webshop_user,(SELECT @a:= 0) AS a WHERE `type`='1' and top_user_vendor =0 and email_verified=1");
