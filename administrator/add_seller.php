            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">
                   Seller<small><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Seller</small>
                   </h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
                       ...
                       <li>
                          <span><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Seller</span>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Add Seller</h4>
                            <span class="tools">
