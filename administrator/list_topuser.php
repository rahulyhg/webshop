...
function top1(aa)
   { 
       location.href="list_topuser.php?cid="+ aa +"&action=top1"
   ...
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="list_topuser.php?cid="+ aa +"&action=delete"
      }  
   } 
   
function inactive(aa)
   { 
       location.href="list_topuser.php?cid="+ aa +"&action=inactive"

   } 
   function active(aa)
   {
     location.href="list_topuser.php?cid="+aa+"&action=active";
   } 

function disable(aa)
   { 
       location.href="list_topuser.php?cid="+ aa +"&action=disable"

   } 
   function enable(aa)
   {
     location.href="list_topuser.php?cid="+aa+"&action=enable";
   }
   </script>
<!-- Header End -->
 <!-- BEGIN CONTAINER -->
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">Certified User list</h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <h4><i class="icon-reorder"></i>List Certified User</h4>
...
if(isset($_GET['action']) && $_GET['action']=='top1')
{
  ...
  exit();
                                                        ...
                                                        $fetch_landlord=mysqli_query($con,"select *,@a:=@a+1 serial_number from webshop_user,(SELECT @a:= 0) AS a WHERE `type`='1' and top_user_vendor =1");
    ...
    $image_link='../upload/user_image/nouser.jpg';
              ...
              <tr>
                 ...
                 <td>
                    ...
                    <?php echo "<br/>(Uncheck for Normal User)"; ?>
                </td> 
                ...
                <td>
                 ...
                 <td>
                  <a  href="certifieduser_products.php?id=<?php echo $landlord['id'] ?>&action=details">
                  List Products</a>
                  </td>

                <td>
                  <a  href="view_topownerdetails.php?id=<?php echo $landlord['id'] ?>&action=details">
                  View Details</a>
                </td>
