                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN Table-->
                              <tr><button type="reset" class="btn blue" onClick="window.location.href='list_vendor.php'" >Back</button></tr>
...
if(isset($_GET['action']) && $_GET['action']=='active')
{
  ...
  exit();
                                                        ...
                                                        $fetch_tools_type=mysqli_query($con,"select * from webshop_products where auctioned = 0 and uploader_id='".$_REQUEST['id']."'");
