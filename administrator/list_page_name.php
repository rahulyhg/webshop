...
<script language="javascript">
    function del(aa, bb)
    {
        ...
        if (a)
        {
            location.href = "list_page_name.php?cid=" + aa + "&action=delete"
        }
    }

    function inactive(aa)
    {
        location.href = "list_page_name.php?cid=" + aa + "&action=inactive"

    }
    function active(aa)
    {
        location.href = "list_page_name.php?cid=" + aa + "&action=active";
    }
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>List Page</h4>
                            <span class="tools">
...
?>
            ...
            <tr>
                ...
                <td>
                  <a  href="add_page_name.php?id=<?php echo $row->id ?>&action=edit">
                  Edit </a>
