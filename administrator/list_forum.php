   ...
   <div id="container" class="row-fluid">
    ...
    <?php include("includes/left_sidebar.php"); ?>
      ...
      <div id="main-content">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">Forum List</h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
        ...
        <tbody>
                            <?php
                                                        $fetch_product=mysqli_query($con,"select * from webshop_forum");
    ...
    $image_link='../upload/no.png';
              ...
              <tr>
                ...
                <td>
                    <a  href="details_forum.php?id=<?php echo $product['id'] ?>&action=details">Comments</a>
