...
$query="SELECT * FROM makeoffer_orders where user_id = '".$_REQUEST['id']."'";
    ...
    <?php include("includes/left_sidebar.php"); ?>
      ...
      <div id="main-content">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">Buyer<small>Purchase history</small></h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
        ...
        Admin Charge($)
          ...
          {
          $fetch_user=mysqli_fetch_object(mysqli_query($con,"select * from `makeoffer_user` where `id`='".$row->user_id."'"));
