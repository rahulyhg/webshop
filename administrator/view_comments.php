            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">Comments list</h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                      ...
                      <!--   <h4><i class="icon-reorder"></i>List Pets</h4> -->
                        <tr><button type="reset" class="btn blue" onClick="window.location.href='list_blogs.php'" >Back</button></tr>
...
// }
    ...
    $fetch_landlord=mysqli_query($con,"select * from webshop_comments where blog_id='".$_REQUEST['id']."' order by id desc");
                                                        $num=mysqli_num_rows($fetch_landlord);
                                                        if($num>0)
                                                        {
                                                        while($landlord=mysqli_fetch_array($fetch_landlord))
                                                        {
 $user_details=mysqli_fetch_array(mysqli_query($con,"select * from webshop_user WHERE id='".$landlord['user_id']."'"));
 ...
 // $total_reports = mysqli_num_rows($reports_user);
    ...
    {
    $image_link='../upload/user_image/'.$user_details['image'];
    }
    else {
    $image_link='../upload/user_image/nouser.jpg';
              ...
              <tr>
                ...
                <td>
                  <?php echo stripslashes($landlord['comment']);?>
                </td> 
