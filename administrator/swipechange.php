...
{
	$item_id=$_GET['cid'];
	mysqli_query($con,"delete from  webshop_swipe where id='".$item_id."'");
	//$_SESSION['msg']=message('deleted successfully',1);
	header('Location:swipechange.php');
	exit();
}
...
{
	 $item_id=$_GET['cid'];
	 mysqli_query($con,"update webshop_swipe set status='0' where id='".$item_id."'");
...
{
	$item_id=$_GET['cid'];
	mysqli_query($con,"update webshop_swipe set status='1' where id='".$item_id."'");
	//$_SESSION['msg']=message('updated successfully',1);
	header('Location:swipechange.php');
	exit();
} 
...
if(isset($_REQUEST['bulk_delete_submit'])){
        ...
        foreach($idArr as $id){
            ...
            mysqli_query($con,"DELETE FROM `webshop_swipe` WHERE id=".$id);
        }
...
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="swipechange.php?cid="+ aa +"&action=delete"
      }  
   } 
   
function inactive(aa)
   { 
       location.href="swipechange.php?cid="+ aa +"&action=inactive"

   } 
   function active(aa)
   {
     location.href="swipechange.php?cid="+aa+"&action=active";
   } 
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">Swipe Changes</h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
