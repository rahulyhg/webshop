            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">List Membership</h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <h4><i class="icon-reorder"></i>List Membership</h4>
...
if(isset($_GET['action']) && $_GET['action']=='active')
{
  ...
  exit();
                                                        ...
                                                        $fetch_tools_type=mysqli_query($con,"select * from webshop_membership");
...
$uploader = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `webshop_user` WHERE `id`='".$tools_type['uploader_id']."'"));
    ...
    $image_link='../upload/no.jpg';
          ...
          <!--       <td>
               ...
               <td>
                   <?php echo stripslashes($tools_type['title']);?>
                </td>

              <!--   <td>
                   <?php echo stripslashes($tools_type['description']);?>
                </td> -->
                ...
                <td>
                   <?php echo stripslashes($tools_type['slot']);?>
                </td>

                  <td>
                   <?php echo stripslashes($tools_type['expire_month']." months");?>
                </td>
