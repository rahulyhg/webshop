...
if($_REQUEST['action']=='details') {
    ...
    $booking_details = mysqli_query($con,"SELECT * FROM `webshop_bookings` WHERE `supplier_id`='".$_REQUEST['id']."'");
...
<!-- Header End -->
 <!-- BEGIN CONTAINER -->
   <div id="container" class="row-fluid">
      ...
      <div id="main-content">
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
                ...
                <!--<i class="fa fa-edit"></i>Editable Table-->
                     ...
                     <tr><button type="reset" class="btn blue" onClick="window.location.href='list_business.php'" >Back</button></tr>
        ...
        <tbody>
             ...
             // $booking_details = mysqli_query($con,"SELECT * FROM `hotels_bookings` WHERE `tool_id`='".mysqli_real_escape_string($con,$_REQUEST['id'])."' and status = 1");
              $user_details = mysqli_query($con,"SELECT * FROM `webshop_user` WHERE `company_id`='".$_REQUEST['id']."' order by id desc");

                                                         
         if(mysqli_num_rows($user_details) >0)
             {
              while($result=mysqli_fetch_assoc($user_details))
    ...
    if($result['image']!='')
    {
    $image_link='../upload/user_image/'.$result['image'];
    }
    else {
    $image_link='../upload/no.png';
              ...
              <tr>
                 ...
                 <td>
                  <?php echo stripslashes($result['fname']." ".$result['lname']);?>
                </td>
...
<!-- 
                 ...
                 <!--  <td>
                  <a  href="user_bookings.php?id=<?php echo $result['user_id'] ?>&action=details">
                  View  User</a>
                </td> -->
