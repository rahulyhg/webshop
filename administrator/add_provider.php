...
{
   $company_id = isset($_POST['tool_type']) ? $_POST['tool_type'] : '';
   ...
   $image =mysqli_query($con,"UPDATE `webshop_user` SET `image`='".$img_name."' WHERE `id` = '" . mysqli_real_escape_string($con,$_REQUEST['id']) . "'");
    ...
    exit();
     ...
     $insertQuery = "INSERT INTO `webshop_user` (`" . implode('`,`', array_keys($fields)) . "`)"
      ...
      $add_baseencode =mysqli_query($con,"UPDATE `webshop_user` SET `webshop_id`= 'YIQI-".base64_encode($last_id)."' WHERE `id` = '" . $last_id . "'");
...
if($_REQUEST['action']=='edit')
{
$categoryRowset = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `webshop_user` WHERE `id`='".mysqli_real_escape_string($con,$_REQUEST['id'])."'"));
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">
                   Provider <small><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Provider</small>
                   </h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
                       ...
                       <li>
                          <span><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?>Provider</span>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Add Provider</h4>
                            <span class="tools">
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                ...
                                $sql = "SELECT * FROM webshop_companies";
                             ...
                             <select name='tool_type' required>
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                                                    ?>
                            <option value='<?php echo $row['id'];?>'  <?php if($row['id']== $categoryRowset['company_id']){?> selected="selected"<?php }?>><?php echo $row['name'];?></option>
                                    <?php 
                                } ?>
