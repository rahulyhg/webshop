        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">List Live Auction</h3>
                    <ul class="breadcrumb">
                        <li>
                            <a href="#">Home</a>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>List Live Auction</h4>
...
if ($num > 0) {
    while ($tools_type = mysqli_fetch_array($fetch_tools_type)) {
        ...
        <?php echo stripslashes($tools_type['owner_number']); ?>
                                                ...
                                                <td>
                                                    <a  href="view_bids.php?id=<?php echo $tools_type['id'] ?>&action=edit&uploader_id=<?php echo $tools_type['uploader_id'] ?>">
