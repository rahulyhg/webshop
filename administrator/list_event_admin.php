...
if(isset($_GET['action']) && $_GET['action']=='delete')
{
	...
	header('Location:list_event_admin.php');
	exit();
}
...
if (isset($_REQUEST['submit'])) {
    ...
    if ($action == 'add' || $action == '') {
       ...
       echo $addQuery = "INSERT INTO `webshop_event` (`" . implode('`,`', array_keys($fields)) . "`)"
...
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="list_event_admin.php?cid="+ aa +"&action=delete"
      }  
   } 
   
function inactive(aa)
   { 
       location.href="list_event_admin.php?cid="+ aa +"&action=inactive"

   } 
   function active(aa)
   {
     location.href="list_event_admin.php?cid="+aa+"&action=active";
   } 
...
<!-- Header End -->
 <!-- BEGIN CONTAINER -->
   <div id="container" class="row-fluid">
    ...
    $eventdetails=$fetch_product['user_event_name'];
    
    
        $sql=mysqli_query($con,"select * from webshop_event WHERE id IN($eventdetails)");
        ...
        {
            //echo "aA".$product['img'];
        //$fetch_store=mysqli_fetch_array(mysqli_query($con,"select * from `webshop_event` "));
        //$image=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `webshop_event`"));
        if($product['img']!='')
        {
    ...
    ?>
              ...
              <tr>
                ...
                <td>
                  <?php echo stripslashes($product['date']); ?>
                </td>
                
                
                <td>
                  <?php echo stripslashes($product['time']); ?>
                </td>
                ...
                <td>
                  <a  href="add_event.php?id=<?php echo $product['id'] ?>&action=edit">
                  Edit </a>
                </td>
