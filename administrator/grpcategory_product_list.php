...
?>
<?php
$category_name=mysqli_fetch_array(mysqli_query($con,"select * from `webshop_grpcategory` where `id`='".$_REQUEST['id']."'"));
?>
            ...
            <div class="row-fluid">
                ...
                <th>
                   ...
                   Details
                                     ...
                                     <tbody>
                               <?php
                                                        $fetch_product=mysqli_query($con,"select * from webshop_product  where `product_type`='P' and status='1' and `cat_id`='".$_REQUEST['id']."'");
