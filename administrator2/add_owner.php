...
if(isset($_REQUEST['submit']))
{
   ...
   $image =mysqli_query($con,"UPDATE `webshop_user` SET `image`='".$img_name."' WHERE `id` = '" . mysqli_real_escape_string($con,$_REQUEST['id']) . "'");
    ...
    header('Location:list_owner.php');
    exit();
          }
          else
          {
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">
                    Owner <small><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?>  Owner</small>
                   </h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
                       ...
                       <li>
                          <span><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Owner</span>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Add Owner</h4>
                            <span class="tools">
