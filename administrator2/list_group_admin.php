...
if(isset($_GET['action']) && $_GET['action']=='delete')
{
	...
	header('Location:list_group_admin.php');
	exit();
}
...
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="list_group_admin.php?cid="+ aa +"&action=delete"
      }  
   } 
   
function inactive(aa)
   { 
       location.href="list_group_admin.php?cid="+ aa +"&action=inactive"

   } 
   function active(aa)
   {
     location.href="list_group_admin.php?cid="+aa+"&action=active";
   } 
...
$sql = mysqli_query($con,"select * from webshop_group WHERE id IN($grpdetails)");
