            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <h4><i class="icon-reorder"></i>List Vendors</h4>
  ...
  exit();
    ...
    $image_link='../upload/user_image/nouser.jpg';
              ...
              <tr>
                ...
                <td>
                 <a href="message_details.php?id=<?php echo $landlord['id'];?>"><button type="button" class="btn btn-primary mr-3">Message</button></a>
                </td>
              </tr>
                                                       <?php
                                                        }
