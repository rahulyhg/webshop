...
//exit;
$petfound = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `webshop_petsfound` WHERE `pet_id`='".$_REQUEST['id']."'"));

$userRow = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `webshop_user` WHERE `id`='".$petfound['user_id']."'"));
   ...
   <div id="container" class="row-fluid">
    ...
    <?php include("includes/left_sidebar.php"); ?>
      ...
      <div id="main-content">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <h3 class="page-title"> Founder Details</h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
        ...
        <tr><button type="reset" class="btn blue" onClick="window.location.href='pets_found.php'" >Back</button></tr>
...
<tr>
<td> Founder Contact No. </th> 
<td><?php echo $userRow['phone']; ?></td>    
</tr>

<tr>    
<td> Founder Address </th>
<td><?php echo $userRow['address']; ?></td>
</tr>


<tr>    
<td> Location Found </th>
<td><?php echo $petfound['found_location']; ?></td>
</tr>

<tr>    
<td> Found Date </th>
<td><?php echo $petfound['found_date']; ?></td>
</tr>

<tr>
<td> Founder Image </td>
<?php
$moreimage1 = mysqli_query($con,"SELECT * FROM `webshop_user` WHERE `id`='".$petfound['user_id']."'");
