...
<!-- Header End -->
    ...
    <?php include("includes/left_sidebar.php"); ?>
      ...
      <div id="main-content">
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">Pending Payments</h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="#">Home</a>
            ...
            <div class="row-fluid">
                <div class="span12">
                       <center><h1 style="margin-top:20%;font-size:48px;font-weight:bold;">Coming Soon</h1></center>
                    <!-- BEGIN SAMPLE FORMPORTLET-->
                    <div class="widget green" style="display:none;">
        ...
        <tbody>
             ...
             $tool_type_details = mysqli_query($con,"SELECT * FROM `uidesign_bookings` order by id desc");
 ...
 $user_details = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `uidesign_user` WHERE `id`='".$result['buyer_id']."'"));

 $product_details = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `uidesign_products` WHERE `id`='".$result['product_id']."'"));
           ...
           <td>
                ...
                <td>
                  <?php echo stripslashes("$".$result['total_price']);?>
                </td>
