            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <h4><i class="icon-reorder"></i>List Transactions</h4>
...
if(isset($_GET['action']) && $_GET['action']=='active')
{
  ...
  exit();
                                                        ...
                                                        $fetch_landlord=mysqli_query($con,"select * from webshop_transactions order by id desc");
    ...
    $image_link='../upload/user_image/nouser.jpg';
              ...
              <tr>
                ...
                <td>
                  <?php echo stripslashes($landlord['invoice_number']);?>
                </td> 

                 <td>
                  <?php echo stripslashes($landlord['invoice_terms']);?>
                </td> 

                  <td>
                  <?php echo stripslashes("$".$landlord['invoice_total']);?>
                </td> 


                 <td>
                 <span class="label label-warning" > <?php echo stripslashes($landlord['status']);?></span>&nbsp;
                </td> 
                 ...
                 <td>
                  <a  href="view_details.php?id=<?php echo $landlord['id'] ?>&action=details">
                  Details </a> 
                   </td>
         <!--      
                <td>
