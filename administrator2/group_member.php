   ...
   <div id="container" class="row-fluid">
    ...
    <?php include("includes/left_sidebar.php"); ?>
      ...
      <div id="main-content">
        ...
        <tbody>
    <?php
  /*  $fetch_product=mysqli_query($con,"select * from webshop_group_members  where `status`='1'");    
...
?>
              ...
              <tr>
                ...
                <td><a href="member_list.php?id=<?php echo $product['id'] ?>&action=details">View</a></td>
