...
$YourEamilPassword="lsnspyrcimuffblr";
  ...
  header('location:selective_vendor.php');
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Selective Vendor</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                          <form class="form-horizontal"  method="post" action="selective_vendor.php">
                            
                            <div class="control-group">
                                    <label class="control-label">Select Language</label>
                                    <div class="controls">
                                     <select name="language" onchange="selectiveVendors(this.value)" >
