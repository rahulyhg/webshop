...
$queryy="SELECT * FROM webshop_orders order by `id` desc ";
...
if(isset($_POST['ExportCsv']))
{
  ...
  $output='';
    ...
    $output .='OrderId,Order By,Order Amount,Order Date';
    ...
    if(mysqli_num_rows($query)>0)
    {
        while($result = mysqli_fetch_assoc($query))
        {
           ...
           if($user_id!=""){
            $output .='"'.$order_id.'","'.$name.'","'. $price.'","'.$date.'"';
            $output .="\n";
            }
        }
    }
      ...
      <div id="main-content">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                           ...
                           <form action="" method="post">
                               ...
                               <button style="float:right;" type="submit"  class="btn blue" name="ExportCsv"> Download Order List</button>
                                                            </form>
                            <span class="tools">
        ...
        Admin Charge($)
         ...
         <?php /*   <td>
          ...
          <?php /*   <td>
          <a href="order_details.php?orderid=<?php echo $row->id;?>">Details</a>
          </td> */?>
