...
$sql="select * from `makeoffer_faqcategories` where 1 order by id desc";
$record=mysqli_query($con,$sql);
if(isset($_GET['action']) && $_GET['action']=='delete')
{
	$item_id=$_GET['cid'];
	mysqli_query($con,"delete from  makeoffer_faqcategories where id='".$item_id."'");
...
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="list_faq_category.php?cid="+ aa +"&action=delete"
      }  
   } 
