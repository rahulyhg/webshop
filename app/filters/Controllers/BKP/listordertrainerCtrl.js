 ...
 */
app.controller('listordertrainerCtrl', function ($rootScope, $scope, $http, $location,$timeout,$templateCache,$window,userService,$state,$stateParams) {
...
userService.orderlisttrainer(userInfo.user_id).then(function(response) {
