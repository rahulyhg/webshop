...
app.controller('messagelistCtrl', function ($rootScope, $scope, $http, $location,$timeout, $window, userService, $stateParams) {
...
userService.messageList(userInfo.user_id).then(function(response) {
