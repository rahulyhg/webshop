 ...
 */
app.controller('addAuctionCtrl', function ($rootScope, $state, $scope, $http, $location,$timeout, $q, userService,$window,Upload) {
...
$scope.addAuction = function(user2){
    ...
    $window.localStorage["cat_id"]=user2.cat_id;
     ...
     // $window.localStorage["auction_start_date"]=user2.auction_start_date;
     // $window.localStorage["auction_end_date"]=user2.auction_end_date;
     $window.localStorage["special_price"]=user2.special_price;
     $window.localStorage["user_id"]=$scope.user_id;
     // $window.localStorage["image"]=user2.image;
