 ...
 */
app.controller('orderdetailsCtrl', function ($rootScope, $scope, $http, $location,$timeout,$templateCache,$window,userService,$state,$stateParams) {
...
userService.orderdetails($stateParams.id).then(function(response) {
		
		$scope.isExists=response.Ack;
		if(response.Ack == '1') {
		$scope.OrderDetailsGeneralUser=response.OrderDetails;
