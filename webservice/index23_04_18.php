...
function addProductNew() {
    ...
    if ($type == '1') {
        ...
        $sql = "INSERT INTO webshop_products (uploader_id, cat_id, subcat_id,currency_code,type,name, description, price, add_date,quantity,brands,movement,gender,reference_number,date_purchase,status_watch,owner_number,country,size,location,work_hours,status) VALUES (:user_id, :cat_id, :subcat_id, :currency_code, :type, :name, :description, :price, :add_date,:quantity,:brand,:movement,:gender,:reference_number,:date_purchase,:status_watch,:owner_number,:country,:size,:location,:work_hours,:status)";
    } else {

        $sql = "INSERT INTO webshop_products (uploader_id, cat_id, subcat_id,currency_code,type,name, description, price, add_date,quantity,brands,movement,gender,reference_number,date_purchase,status_watch,owner_number,country,size,preferred_date,location,work_hours,status) VALUES (:user_id, :cat_id, :subcat_id, :currency_code, :type, :name, :description, :price, :add_date,:quantity,:brand,:movement,:gender,:reference_number,:date_purchase,:status_watch,:owner_number,:country,:size,:preferred_date,:location,:work_hours,:status)";
    }
...
function addUserSubscription() {
    ...
    $sql = "UPDATE  webshop_user SET subscription_id=:subscription_id WHERE id=:user_id";
    $stmt = $db->prepare($sql);
