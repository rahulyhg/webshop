...
// exit;
        ...
        $sql = "SELECT * from  webshop_products where status=1 and type='1' and is_discard='0'  and uploader_id !='" . $user_id . "'";
    }
...
function reviews() {
    ...
    $sql = "SELECT * from webshop_reviews where product_id =$productid";
